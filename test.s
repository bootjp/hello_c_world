...
Lcfi2:
	...
	movq	%rdi, -8(%rbp)
Ltmp0:
	.loc	1 2 10 prologue_end     ## test.c:2:10
	movq	-8(%rbp), %rdi
	.loc	1 2 12 is_stmt 0        ## test.c:2:12
	cmpl	$2, (%rdi)
Ltmp1:
	.loc	1 2 9                   ## test.c:2:9
	jl	LBB0_2
## BB#1:
Ltmp2:
	.loc	1 3 9 is_stmt 1         ## test.c:3:9
	jmp	LBB0_3
Ltmp3:
LBB0_2:
	.loc	1 5 6                   ## test.c:5:6
	movq	-8(%rbp), %rax
	.loc	1 5 8 is_stmt 0         ## test.c:5:8
	movl	(%rax), %ecx
	addl	$1, %ecx
	movl	%ecx, (%rax)
	.loc	1 6 15 is_stmt 1        ## test.c:6:15
	movq	-8(%rbp), %rdi
	.loc	1 6 5 is_stmt 0         ## test.c:6:5
	callq	_recursion
LBB0_3:
	.loc	1 7 1 is_stmt 1         ## test.c:7:1
	addq	$16, %rsp
	popq	%rbp
	retq
Ltmp4:
...
Ltmp5:
	...
	.loc	1 10 9 prologue_end     ## test.c:10:9
	movl	$0, -8(%rbp)
	.loc	1 11 5                  ## test.c:11:5
	callq	_recursion
Ltmp6:
	.loc	1 0 5 is_stmt 0         ## test.c:0:5
	xorl	%eax, %eax
	.loc	1 12 5 is_stmt 1        ## test.c:12:5
	addq	$16, %rsp
	popq	%rbp
	retq
Ltmp7:
